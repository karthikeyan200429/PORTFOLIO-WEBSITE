  ...
  return (
    <div className="flex flex-col items-center w-full max-w-4xl p-4">
      ...
      <div className={`flex flex-col items-center text-center`}>
        <div 
          className={`relative p-1 bg-gradient-to-tr from-cyan-400 to-brand-teal-600 rounded-full shadow-lg mt-1 ${baseTransition} ${animationState(animated)}`}
        ...
        <h1 
          className={`mt-4 text-4xl sm:text-5xl font-bold text-white uppercase ${baseTransition} ${animationState(animated)}`}
          style={{ transitionDelay: '200ms' }}
        >
          Karthikeyan P
        </h1>
        <p 
          className={`mt-2 text-lg sm:text-xl text-gray-300 ${baseTransition} ${animationState(animated)}`}
        ...
        <p 
          className={`mt-4 max-w-2xl text-base sm:text-lg text-gray-400 leading-relaxed ${baseTransition} ${animationState(animated)}`}
      ...
      {/* Icon Buttons */}
      <div 
        className={`flex-grow flex items-center justify-center my-2 sm:my-6 w-full ${baseTransition} ${animationState(animated)}`}
